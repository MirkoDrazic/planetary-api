...
def login():
    ...
    if test:
        ...
        return jsonify(message='Login succeeded!', access_tokena=access_token)
    else:
...
def add_planet():
    ...
    if test:
        return jsonify('There is already a planet bt that name'), 409
    else:
...
def remove_planet(planet_id: int):
    ...
    if planet:
        ...
        return jsonify(message='That planet was not there'), 404
